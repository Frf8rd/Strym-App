...
export const translations = {
    english: {
        ...
        aboutUs: 'About Us',
        aboutUsDescription: 'Welcome to Strym! We are a social platform that connects people through meaningful conversations and shared experiences.',
        followers: 'Followers',
        account: 'Account',
    ...
    romanian: {
        ...
        forYou: 'Pentru tine',
        following: 'Urmărești',
        trendingUsers: 'Utilizatori Populari',
        aboutUs: 'Despre Noi',
        aboutUsDescription: 'Bine ai venit pe Strym! Suntem o platformă socială care conectează oamenii prin conversații semnificative și experiențe împărtășite.',
